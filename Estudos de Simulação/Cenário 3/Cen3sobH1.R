...
# Funcao para tal = -0.5
cen3h1_50 <- function(n, rep=5000, B=1000){
...
cen3h1_25 <- function(n, rep=5000, B=1000){
  # Definindo a semente principal
  set.seed(8261)
...
# Funcao para tal = 0.5
cen3h150 <- function(n, rep=5000, B=1000){
  # Definindo a semente principal
  set.seed(8261)
...
# Funcao para tal = 0.25
cen3h125 <- function(n, rep=5000, B=1000){
  # Definindo a semente principal
  set.seed(8261)
...
cen3h1_50(50,5000,1000)
cen3h1_50(100,5000,1000)

cen3h1_25(50,5000,1000)
cen3h1_25(100,5000,1000)

cen3h150(50,5000,1000)
cen3h150(100,5000,1000)

cen3h125(50,5000,1000)
cen3h125(100,5000,1000)