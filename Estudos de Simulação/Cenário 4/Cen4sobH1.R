...
# Funcao para tal = -0.5
cen4h1_50 <- function(n, rep=5000, B=1000){
  ...
  X <- cbind(1, rnorm(n, 1/2, 1/12), rgamma(n, 3, 6))
...
cen4h1_25 <- function(n, rep=5000, B=1000){
  # Definindo a semente principal
  set.seed(8261)
...
# Funcao para tal = 0.5
cen4h150 <- function(n, rep=5000, B=1000){
  # Definindo a semente principal
  set.seed(8261)
...
# Funcao para tal = 0.25
cen4h125 <- function(n, rep=5000, B=1000){
  # Definindo a semente principal
  set.seed(8261)
...
cen4h1_50(50,5000,1000)
cen4h1_50(100,5000,1000)

cen4h1_25(50,5000,1000)
cen4h1_25(100,5000,1000)

cen4h150(50,5000,1000)
cen4h150(100,5000,1000)

cen4h125(50,5000,1000)
cen4h125(100,5000,1000)