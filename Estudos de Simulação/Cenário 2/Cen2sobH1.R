...
# Funcao para tal = -0.5
cen2h1_50 <- function(n, rep=5000, B=1000){
...
cen2h1_25 <- function(n, rep=5000, B=1000){
  # Definindo a semente principal
  set.seed(8261)
  ...
  # Definindo os betas arbitrarios
  betas <- matrix(data=c(-1,1.1,-0.25,
                         -1.5,1.1,-0.25,
                         4.6,0,0),
                  nrow = 3,ncol = 3,byrow = TRUE)
  # Definindo a matriz X com as covariaveis
...
# Funcao para tal = 0.5
cen2h150 <- function(n, rep=5000, B=1000){
  # Definindo a semente principal
  set.seed(8261)
...
# Funcao para tal = 0.25
cen2h125 <- function(n, rep=5000, B=1000){
  # Definindo a semente principal
  set.seed(8261)
...
cen2h1_50(50,5000,1000)
cen2h1_50(100,5000,1000)

cen2h1_25(50,5000,1000)
cen2h1_25(100,5000,1000)

cen2h150(50,5000,1000)
cen2h150(100,5000,1000)

cen2h125(50,5000,1000)
cen2h125(100,5000,1000)