# Códigos TCC - Correções de Bartlett baseadas em bootstrap no modelo de regressão Dirichlet com parametrização baseada no vetor médias
...
```r
install.packages(c("DirichletReg", "tidyverse", "gamlss", "future.apply"))
```
